...
<TechGrid :items="[
  ...
  { title: '前端工程化', description: '稳定工程模块，覆盖图解入门、从零到项目落地、Vite、规范、环境、依赖、测试、Monorepo、组件库工程、构建部署、包体积、模块联邦、工程性能和排错。', link: '/engineering/introduction', level: '工程' },
...
| Vue Admin 文档太多不知道下一篇看什么 | [Vue Admin 阅读顺序与实战索引](/vue/admin-reading-guide) |
...
| 做 CSS 样式系统项目 | [CSS 从零到项目落地](/css/project-from-zero) |
| 查 CSS 项目样式问题 | [CSS 真实项目问题库](/projects/issues-css) |
| 补浏览器与网络 | [浏览器学习导览](/browser/introduction) |
| 做浏览器请求调试项目 | [浏览器与网络从零到项目落地](/browser/project-from-zero) |
...
| 做工程化交付项目 | [前端工程化从零到项目落地](/engineering/project-from-zero) |
