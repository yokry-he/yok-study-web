...
<LearningPath :steps="[
  ...
  { title: '从零到项目落地', description: '用后台管理系统样式骨架串起布局、Token、响应式、组件库边界、可访问性和验收清单。', link: '/css/project-from-zero', badge: '项目' },
...
从 [图解 CSS 核心概念](/css/visual-guide) 开始，再进入 [盒模型与布局基础](/css/box-model-layout)。如果你想把 CSS 用到真实项目里，继续看 [CSS 从零到项目落地](/css/project-from-zero)。如果你已经在项目里遇到样式异常，直接看 [CSS 真实项目问题库](/projects/issues-css)。
